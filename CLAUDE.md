...
- Five carry-forward updates pending: Contact Entity PRD v1.3 → v1.4, Account Entity PRD v1.3 → v1.4, MN-INTAKE v2.3 → v2.4, CR Domain Overview v1.1 → v1.2, Campaign Entity PRD (Phase 2b; must include three-value channel enum, population field for Reactivation channel, and three-status lifecycle for Reactivation channel)
